...
const ForwardRef = forwardRef(AlertsFeedbackNotificationText);
AlertsFeedbackNotificationText.displayName = 'AlertsFeedbackNotificationText';
export default AlertsFeedbackNotificationText;