...
const ForwardRef = forwardRef(AlertsFeedbackBellRinging01);
AlertsFeedbackBellRinging01.displayName = 'AlertsFeedbackBellRinging01';
export default AlertsFeedbackBellRinging01;