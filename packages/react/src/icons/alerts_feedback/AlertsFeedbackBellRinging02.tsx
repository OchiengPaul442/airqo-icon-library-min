...
const ForwardRef = forwardRef(AlertsFeedbackBellRinging02);
AlertsFeedbackBellRinging02.displayName = 'AlertsFeedbackBellRinging02';
export default AlertsFeedbackBellRinging02;