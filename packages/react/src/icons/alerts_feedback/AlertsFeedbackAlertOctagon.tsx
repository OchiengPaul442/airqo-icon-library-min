...
const ForwardRef = forwardRef(AlertsFeedbackAlertOctagon);
AlertsFeedbackAlertOctagon.displayName = 'AlertsFeedbackAlertOctagon';
export default AlertsFeedbackAlertOctagon;