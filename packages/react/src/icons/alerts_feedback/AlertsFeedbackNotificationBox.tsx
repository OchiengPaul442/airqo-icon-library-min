...
const ForwardRef = forwardRef(AlertsFeedbackNotificationBox);
AlertsFeedbackNotificationBox.displayName = 'AlertsFeedbackNotificationBox';
export default AlertsFeedbackNotificationBox;