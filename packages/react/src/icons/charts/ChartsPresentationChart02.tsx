...
const ForwardRef = forwardRef(ChartsPresentationChart02);
ChartsPresentationChart02.displayName = 'ChartsPresentationChart02';
export default ChartsPresentationChart02;