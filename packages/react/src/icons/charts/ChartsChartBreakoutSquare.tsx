...
const ForwardRef = forwardRef(ChartsChartBreakoutSquare);
ChartsChartBreakoutSquare.displayName = 'ChartsChartBreakoutSquare';
export default ChartsChartBreakoutSquare;