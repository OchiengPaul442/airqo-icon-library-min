...
import { IconProps } from '@airqo-icons-min/core';
...
// Component types
export declare type AirqoIconComponent = React.FC<IconProps>;

// Basic declarations for all icons
export declare const AlertCircle: AirqoIconComponent;
export declare const AlertHexagon: AirqoIconComponent;
export declare const AlertOctagon: AirqoIconComponent;
// ...and other icons

// Fallback export to allow dynamic access
declare const icons: Record<string, AirqoIconComponent>;
