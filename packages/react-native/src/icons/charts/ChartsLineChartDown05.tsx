...
const ChartsLineChartDown05WithProps = withIconProps(ChartsLineChartDown05);
ChartsLineChartDown05WithProps.displayName = 'ChartsLineChartDown05';
export default ChartsLineChartDown05WithProps;