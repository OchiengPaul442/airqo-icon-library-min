...
const ChartsBarChart07WithProps = withIconProps(ChartsBarChart07);
ChartsBarChart07WithProps.displayName = 'ChartsBarChart07';
export default ChartsBarChart07WithProps;