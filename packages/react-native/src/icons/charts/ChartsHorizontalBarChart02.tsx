...
const ChartsHorizontalBarChart02WithProps = withIconProps(ChartsHorizontalBarChart02);
ChartsHorizontalBarChart02WithProps.displayName = 'ChartsHorizontalBarChart02';
export default ChartsHorizontalBarChart02WithProps;