...
const ChartsChartBreakoutCircleWithProps = withIconProps(ChartsChartBreakoutCircle);
ChartsChartBreakoutCircleWithProps.displayName = 'ChartsChartBreakoutCircle';
export default ChartsChartBreakoutCircleWithProps;