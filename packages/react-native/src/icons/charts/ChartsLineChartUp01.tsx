...
const ChartsLineChartUp01WithProps = withIconProps(ChartsLineChartUp01);
ChartsLineChartUp01WithProps.displayName = 'ChartsLineChartUp01';
export default ChartsLineChartUp01WithProps;