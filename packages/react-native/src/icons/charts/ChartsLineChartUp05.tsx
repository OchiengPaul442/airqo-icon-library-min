...
const ChartsLineChartUp05WithProps = withIconProps(ChartsLineChartUp05);
ChartsLineChartUp05WithProps.displayName = 'ChartsLineChartUp05';
export default ChartsLineChartUp05WithProps;