...
const ChartsLineChartDown01WithProps = withIconProps(ChartsLineChartDown01);
ChartsLineChartDown01WithProps.displayName = 'ChartsLineChartDown01';
export default ChartsLineChartDown01WithProps;