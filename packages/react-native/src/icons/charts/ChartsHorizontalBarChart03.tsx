...
const ChartsHorizontalBarChart03WithProps = withIconProps(ChartsHorizontalBarChart03);
ChartsHorizontalBarChart03WithProps.displayName = 'ChartsHorizontalBarChart03';
export default ChartsHorizontalBarChart03WithProps;