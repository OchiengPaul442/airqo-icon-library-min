...
const ChartsPresentationChart02 = ({
  title,
  titleId,
  ...props
...
const ChartsPresentationChart02WithProps = withIconProps(ChartsPresentationChart02);
ChartsPresentationChart02WithProps.displayName = 'ChartsPresentationChart02';
export default ChartsPresentationChart02WithProps;