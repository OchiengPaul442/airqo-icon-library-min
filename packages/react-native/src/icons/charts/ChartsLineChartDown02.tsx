...
const ChartsLineChartDown02WithProps = withIconProps(ChartsLineChartDown02);
ChartsLineChartDown02WithProps.displayName = 'ChartsLineChartDown02';
export default ChartsLineChartDown02WithProps;