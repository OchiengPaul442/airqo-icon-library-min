...
const ChartsBarLineChartWithProps = withIconProps(ChartsBarLineChart);
ChartsBarLineChartWithProps.displayName = 'ChartsBarLineChart';
export default ChartsBarLineChartWithProps;