...
const ChartsBarChart11WithProps = withIconProps(ChartsBarChart11);
ChartsBarChart11WithProps.displayName = 'ChartsBarChart11';
export default ChartsBarChart11WithProps;