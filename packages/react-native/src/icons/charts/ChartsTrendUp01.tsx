...
const ChartsTrendUp01WithProps = withIconProps(ChartsTrendUp01);
ChartsTrendUp01WithProps.displayName = 'ChartsTrendUp01';
export default ChartsTrendUp01WithProps;