...
const ChartsBarChart08WithProps = withIconProps(ChartsBarChart08);
ChartsBarChart08WithProps.displayName = 'ChartsBarChart08';
export default ChartsBarChart08WithProps;