...
const ChartsBarChart12WithProps = withIconProps(ChartsBarChart12);
ChartsBarChart12WithProps.displayName = 'ChartsBarChart12';
export default ChartsBarChart12WithProps;