...
const ChartsPieChart03WithProps = withIconProps(ChartsPieChart03);
ChartsPieChart03WithProps.displayName = 'ChartsPieChart03';
export default ChartsPieChart03WithProps;