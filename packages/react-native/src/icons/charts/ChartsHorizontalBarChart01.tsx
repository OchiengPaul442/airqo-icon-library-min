...
const ChartsHorizontalBarChart01WithProps = withIconProps(ChartsHorizontalBarChart01);
ChartsHorizontalBarChart01WithProps.displayName = 'ChartsHorizontalBarChart01';
export default ChartsHorizontalBarChart01WithProps;