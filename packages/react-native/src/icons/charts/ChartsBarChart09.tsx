...
const ChartsBarChart09WithProps = withIconProps(ChartsBarChart09);
ChartsBarChart09WithProps.displayName = 'ChartsBarChart09';
export default ChartsBarChart09WithProps;