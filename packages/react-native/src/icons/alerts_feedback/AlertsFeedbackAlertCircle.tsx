...
const AlertsFeedbackAlertCircleWithProps = withIconProps(AlertsFeedbackAlertCircle);
AlertsFeedbackAlertCircleWithProps.displayName = 'AlertsFeedbackAlertCircle';
export default AlertsFeedbackAlertCircleWithProps;