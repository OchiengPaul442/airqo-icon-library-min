...
const AlertsFeedbackThumbsDownWithProps = withIconProps(AlertsFeedbackThumbsDown);
AlertsFeedbackThumbsDownWithProps.displayName = 'AlertsFeedbackThumbsDown';
export default AlertsFeedbackThumbsDownWithProps;