...
const AlertsFeedbackBellPlusWithProps = withIconProps(AlertsFeedbackBellPlus);
AlertsFeedbackBellPlusWithProps.displayName = 'AlertsFeedbackBellPlus';
export default AlertsFeedbackBellPlusWithProps;