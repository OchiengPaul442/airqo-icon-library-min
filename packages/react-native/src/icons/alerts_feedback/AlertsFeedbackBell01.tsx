...
const AlertsFeedbackBell01WithProps = withIconProps(AlertsFeedbackBell01);
AlertsFeedbackBell01WithProps.displayName = 'AlertsFeedbackBell01';
export default AlertsFeedbackBell01WithProps;