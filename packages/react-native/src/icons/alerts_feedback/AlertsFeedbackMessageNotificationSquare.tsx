...
const AlertsFeedbackMessageNotificationSquareWithProps = withIconProps(AlertsFeedbackMessageNotificationSquare);
AlertsFeedbackMessageNotificationSquareWithProps.displayName = 'AlertsFeedbackMessageNotificationSquare';
export default AlertsFeedbackMessageNotificationSquareWithProps;