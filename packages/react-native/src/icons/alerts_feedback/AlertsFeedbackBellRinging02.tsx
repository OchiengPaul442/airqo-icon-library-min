...
const AlertsFeedbackBellRinging02 = ({
  title,
  titleId,
  ...props
...
const AlertsFeedbackBellRinging02WithProps = withIconProps(AlertsFeedbackBellRinging02);
AlertsFeedbackBellRinging02WithProps.displayName = 'AlertsFeedbackBellRinging02';
export default AlertsFeedbackBellRinging02WithProps;