...
const AlertsFeedbackBellRinging04WithProps = withIconProps(AlertsFeedbackBellRinging04);
AlertsFeedbackBellRinging04WithProps.displayName = 'AlertsFeedbackBellRinging04';
export default AlertsFeedbackBellRinging04WithProps;