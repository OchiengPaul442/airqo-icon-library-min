...
const AlertsFeedbackThumbsUpWithProps = withIconProps(AlertsFeedbackThumbsUp);
AlertsFeedbackThumbsUpWithProps.displayName = 'AlertsFeedbackThumbsUp';
export default AlertsFeedbackThumbsUpWithProps;