...
const AlertsFeedbackNotificationText = ({
  title,
  titleId,
  ...props
...
const AlertsFeedbackNotificationTextWithProps = withIconProps(AlertsFeedbackNotificationText);
AlertsFeedbackNotificationTextWithProps.displayName = 'AlertsFeedbackNotificationText';
export default AlertsFeedbackNotificationTextWithProps;