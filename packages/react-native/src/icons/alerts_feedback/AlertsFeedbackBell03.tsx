...
const AlertsFeedbackBell03WithProps = withIconProps(AlertsFeedbackBell03);
AlertsFeedbackBell03WithProps.displayName = 'AlertsFeedbackBell03';
export default AlertsFeedbackBell03WithProps;