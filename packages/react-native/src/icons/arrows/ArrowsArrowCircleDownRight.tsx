...
const ArrowsArrowCircleDownRight = ({
  title,
  titleId,
  ...props
...
const ArrowsArrowCircleDownRightWithProps = withIconProps(ArrowsArrowCircleDownRight);
ArrowsArrowCircleDownRightWithProps.displayName = 'ArrowsArrowCircleDownRight';
export default ArrowsArrowCircleDownRightWithProps;