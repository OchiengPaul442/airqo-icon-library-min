...
const ArrowsCornerDownRightWithProps = withIconProps(ArrowsCornerDownRight);
ArrowsCornerDownRightWithProps.displayName = 'ArrowsCornerDownRight';
export default ArrowsCornerDownRightWithProps;