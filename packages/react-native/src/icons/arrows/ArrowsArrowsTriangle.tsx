...
const ArrowsArrowsTriangleWithProps = withIconProps(ArrowsArrowsTriangle);
ArrowsArrowsTriangleWithProps.displayName = 'ArrowsArrowsTriangle';
export default ArrowsArrowsTriangleWithProps;