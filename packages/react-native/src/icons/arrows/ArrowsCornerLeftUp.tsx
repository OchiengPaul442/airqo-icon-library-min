...
const ArrowsCornerLeftUpWithProps = withIconProps(ArrowsCornerLeftUp);
ArrowsCornerLeftUpWithProps.displayName = 'ArrowsCornerLeftUp';
export default ArrowsCornerLeftUpWithProps;