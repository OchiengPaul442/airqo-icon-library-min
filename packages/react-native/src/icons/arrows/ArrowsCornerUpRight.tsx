...
const ArrowsCornerUpRightWithProps = withIconProps(ArrowsCornerUpRight);
ArrowsCornerUpRightWithProps.displayName = 'ArrowsCornerUpRight';
export default ArrowsCornerUpRightWithProps;