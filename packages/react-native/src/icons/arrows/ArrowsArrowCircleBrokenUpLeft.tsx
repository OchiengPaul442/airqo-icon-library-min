...
const ArrowsArrowCircleBrokenUpLeftWithProps = withIconProps(ArrowsArrowCircleBrokenUpLeft);
ArrowsArrowCircleBrokenUpLeftWithProps.displayName = 'ArrowsArrowCircleBrokenUpLeft';
export default ArrowsArrowCircleBrokenUpLeftWithProps;