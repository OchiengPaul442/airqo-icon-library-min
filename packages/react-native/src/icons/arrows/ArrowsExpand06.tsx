...
const ArrowsExpand06WithProps = withIconProps(ArrowsExpand06);
ArrowsExpand06WithProps.displayName = 'ArrowsExpand06';
export default ArrowsExpand06WithProps;