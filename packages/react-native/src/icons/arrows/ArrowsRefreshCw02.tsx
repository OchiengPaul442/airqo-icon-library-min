...
const ArrowsRefreshCw02WithProps = withIconProps(ArrowsRefreshCw02);
ArrowsRefreshCw02WithProps.displayName = 'ArrowsRefreshCw02';
export default ArrowsRefreshCw02WithProps;