...
const ArrowsRefreshCcw02WithProps = withIconProps(ArrowsRefreshCcw02);
ArrowsRefreshCcw02WithProps.displayName = 'ArrowsRefreshCcw02';
export default ArrowsRefreshCcw02WithProps;