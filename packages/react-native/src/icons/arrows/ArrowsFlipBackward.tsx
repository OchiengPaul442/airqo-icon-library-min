...
const ArrowsFlipBackwardWithProps = withIconProps(ArrowsFlipBackward);
ArrowsFlipBackwardWithProps.displayName = 'ArrowsFlipBackward';
export default ArrowsFlipBackwardWithProps;