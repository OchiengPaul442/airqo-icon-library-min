...
const ArrowsArrowCircleBrokenRightWithProps = withIconProps(ArrowsArrowCircleBrokenRight);
ArrowsArrowCircleBrokenRightWithProps.displayName = 'ArrowsArrowCircleBrokenRight';
export default ArrowsArrowCircleBrokenRightWithProps;