...
const ArrowsCornerRightUpWithProps = withIconProps(ArrowsCornerRightUp);
ArrowsCornerRightUpWithProps.displayName = 'ArrowsCornerRightUp';
export default ArrowsCornerRightUpWithProps;