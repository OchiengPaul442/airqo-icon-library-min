...
const ArrowsArrowCircleBrokenDownRightWithProps = withIconProps(ArrowsArrowCircleBrokenDownRight);
ArrowsArrowCircleBrokenDownRightWithProps.displayName = 'ArrowsArrowCircleBrokenDownRight';
export default ArrowsArrowCircleBrokenDownRightWithProps;