...
const ArrowsRefreshCw05WithProps = withIconProps(ArrowsRefreshCw05);
ArrowsRefreshCw05WithProps.displayName = 'ArrowsRefreshCw05';
export default ArrowsRefreshCw05WithProps;