...
const ArrowsRefreshCcw05WithProps = withIconProps(ArrowsRefreshCcw05);
ArrowsRefreshCcw05WithProps.displayName = 'ArrowsRefreshCcw05';
export default ArrowsRefreshCcw05WithProps;