...
const ArrowsArrowCircleDownWithProps = withIconProps(ArrowsArrowCircleDown);
ArrowsArrowCircleDownWithProps.displayName = 'ArrowsArrowCircleDown';
export default ArrowsArrowCircleDownWithProps;