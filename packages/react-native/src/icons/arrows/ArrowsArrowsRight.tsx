...
const ArrowsArrowsRightWithProps = withIconProps(ArrowsArrowsRight);
ArrowsArrowsRightWithProps.displayName = 'ArrowsArrowsRight';
export default ArrowsArrowsRightWithProps;