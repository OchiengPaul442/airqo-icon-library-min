...
const ArrowsRefreshCcw04WithProps = withIconProps(ArrowsRefreshCcw04);
ArrowsRefreshCcw04WithProps.displayName = 'ArrowsRefreshCcw04';
export default ArrowsRefreshCcw04WithProps;