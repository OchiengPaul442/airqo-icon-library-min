...
const ArrowsRefreshCcw03WithProps = withIconProps(ArrowsRefreshCcw03);
ArrowsRefreshCcw03WithProps.displayName = 'ArrowsRefreshCcw03';
export default ArrowsRefreshCcw03WithProps;