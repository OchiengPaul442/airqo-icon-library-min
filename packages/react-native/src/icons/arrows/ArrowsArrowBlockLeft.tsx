...
const ArrowsArrowBlockLeftWithProps = withIconProps(ArrowsArrowBlockLeft);
ArrowsArrowBlockLeftWithProps.displayName = 'ArrowsArrowBlockLeft';
export default ArrowsArrowBlockLeftWithProps;